...
namespace utils {
    ...
    template<typename T>
    std::string join(
            const std::initializer_list<T>& elems, 
            const std::string& sep = std::string(" ")
    ) {
        return join(vector<T>(elems), sep);
    }
    ...
    inline void _test() {
        ...
        string str1a = "";
        string str2a = "alberto";
        string str3a = "alberto armando augusto";
        string str4a = "alberto     armando  \t\n  augusto";

        print("\n");
        cout << "utils::split(str1a) -> "; print("|{}|\n", utils::split(str1a));
        cout << "utils::split(str2a) -> "; print("{}\n", utils::split(str2a));
        cout << "utils::split(str3a) -> "; print("{}\n", utils::split(str3a));
        cout << "utils::split(str4a) -> "; print("{}\n", utils::split(str4a));
